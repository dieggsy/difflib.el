* difflib.el
[[http://melpa.milkbox.net/#/difflib][file:http://melpa.milkbox.net/packages/difflib.svg]]
[[https://stable.melpa.org/#/difflib][file:https://stable.melpa.org/packages/difflib.svg]]
